...
class Asenath {
    ...
    public Asenath(User user, bool isDefeated, string CHECKPOINT, string filePath) {
        this.user = user;
    ...
    public void Bossfight_4() {
        ...
        ║   HP: {user.HP,-3}/100                        HP: {BOSS_HP,-3}/350                         ║
        ║                                                                          ║
        ║         ____                                                             ║
        ║        |    |                                                            ║
        ║      __|    |__                                                          ║
        ...
        ║   () |       | ()                      () |       | ()                   ║
        ║==========================================================================║
        ║ Name: Gary                        | Name: Asenath                        ║
        ║ {user.HP,-3}/100 HP                        | {BOSS_HP,-3}/350 HP                           ║
        ║                                   |                                      ║
        ║ Strength:                         | Strength:                            ║
    ...
    private void A_choice() {
        ...
        Console.WriteLine($"\nYou attacked ASENATH!! His HP dropped by {user.Strength}");
        Thread.Sleep(1500);
        
        Console.ForegroundColor = ConsoleColor.Red;
        Console.WriteLine($"ASENATH gives you -{BOSS_strength} damage");
        Thread.Sleep(2000);
    ...
    private void AfterWin() {
        ...
        Console.ForegroundColor = ConsoleColor.Green;
        Console.WriteLine("You defeated ASENATH");
        Thread.Sleep(1000);
        ...
        if (this.checkpoint == "TRMX") {
            this.checkpoint = "ASYR";
        }
    ...
    private void AfterLoss() {
        ...
        Thread.Sleep(1000);
        Console.WriteLine("ASENATH remains in his post..");
        Thread.Sleep(2000);
        Console.ForegroundColor = ConsoleColor.Green;
